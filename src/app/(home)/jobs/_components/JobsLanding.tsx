        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <Link href="/post-job" className="no-underline">
              <Card className="h-full flex flex-col justify-between hover:shadow-lg transition-all duration-200 bg-white rounded-xl border border-gray-200 p-6 text-center group hover:border-green-300">
                <CardHeader className="p-0">
