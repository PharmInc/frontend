    ...
    <div className="min-h-screen bg-gray-50 font-sans">
      <div className="max-w-lg mx-auto pt-24 px-6">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-3 font-sans">Save your favorites</h1>
          <p className="text-gray-600 text-lg font-sans">Sign up to bookmark posts and content</p>
        </div>
          ...
          <CardContent className="p-8">
            <div className="space-y-6">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600 font-sans">Discover and save content from healthcare professionals</p>
              </div>
